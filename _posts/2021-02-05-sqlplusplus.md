...
One of the challenges that SQL practitioners experience using noSQL databases, such as MongoDB, is that these databases use a query language that is syntactically different to SQL.  
